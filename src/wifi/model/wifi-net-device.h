...
public:
  ...
  /**
   * Set the callback to be used to notify the TopologyRSUAp when a packet
   * has been received.
   *
   * \param cb The callback.
   */
  virtual void SetTopologyReceiveCallback (NetDevice::PromiscReceiveCallback cb);
...
private:
  ...
  /**
   * The callback used to notify TopologyRsuAp that a packet has been received.
   */
  NetDevice::PromiscReceiveCallback m_topologyRxCallback;
